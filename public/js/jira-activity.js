    ...
    AP.define('JiraActivity', {
        buildProjectTable: function(projects, selector) {
            ...
            function buildTableAndReturnTbody(hostElement) {
                ...
                projHeadRow.append("th").text("Label");
            ...
            for (var i= 0; i<issue.length; i++) {
                ...
                cell2.innerHTML = issue[i].fields.project.name;
                var cell3 = row.insertCell(0);
                cell3.innerHTML = issue[i].fields.labels['0'];
                var cell4 = row.insertCell(0);
                cell4.innerHTML = issue[i].fields.status.name;
                var cell6 = row.insertCell(0);
                cell6.innerHTML = issue[i].fields.summary;
                var cell5 = row.insertCell(0);
                cell5.innerHTML = '<a href="'+baseUrl+'/browse/'+ issue[i].key+'">'+issue[i].key+'</a>';
                var cell0 = row.insertCell(0);
                cell0.innerHTML = '<img src="'+ issue[i].fields.issuetype.iconUrl + '">';
